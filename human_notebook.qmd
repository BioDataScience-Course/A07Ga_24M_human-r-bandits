...
chart(data = biometry2, masse_real ~ tour_poignet | genre) + geom_point() + ylab("Masse de l'individu kg") + xlab("tout du poignet cm")
...
=======
```
>>>>>>> ca052d27ccfb18a2006d76cd3f20afde495f57a3
...
```{r plot_indice1}
chart(data = biometry2, masse_real ~ wwr | genre) + geom_point() + ylab("Masse de l'individu kg") + xlab("rapport taille et poignet ")
...
```{r plot_indice4}
# Graphique ou tableau utilisant l'indice calculé.
chart(biometry2, masse_real ~ bmi)+
  geom_point()
